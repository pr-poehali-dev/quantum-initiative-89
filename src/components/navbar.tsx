        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex-shrink-0">
            <h1 className="font-orbitron text-xl font-bold text-white">
              Volt<span className="text-primary">Tabs</span>
            </h1>
          </div>
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <a href="#flavors" className="font-geist text-white hover:text-primary transition-colors duration-200">
                Flavors
              </a>
          ...
          {/* CTA Button */}
          <div className="hidden md:block">
            <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-geist border-0">Buy Now</Button>
          </div>
          ...
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-black/98 border-t border-primary/20">
              ...
              <div className="px-3 py-2">
                <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-geist border-0">
                  Buy Now
                </Button>
              </div>
            </div>
